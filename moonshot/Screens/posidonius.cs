...
{
    class posidonius : screen
    {
        public override string Name {
            get { return "Posidonius"; }
        }
        ...
        private static void Message() {
            ...
            Raylib.DrawText("Posidonius", (Raylib.GetScreenWidth()-("Posidonius".Length * 15))/2, Raylib.GetScreenHeight()/5*4+10, 30, BLACK);
        ...
        private static void Confirmation(){
            if (PressSPACEBAR()) {                                                      //"From Posidonius it is 193 Miles\nto Montes Taurus."
                mainTrail.popUpMessages[MainWindow.settings.userStats.currentLocation] = ("From Posidonius it is 193 Miles\nto Montes Taurus.", false, String.Empty);
                Raylib.StopSound(sound);
                MainWindow.settings.currentScreen = "Check Stats";
                MainWindow.settings.userStats.currentLocation = 4;
                loopCount = 0;
            }
        }

        // space center
        internal static Sound sound = LoadSound("Music/POL-bomberguy-short.wav");
